...
class Zend_Db_Select
{
    ...
    const SQL_ASC        = 'ASC';
    const SQL_DESC       = 'DESC';
    const SQL_CALC		 = 'SQL_CALC_FOUND_ROWS';
     ...
     * @return Zend_Db_Select This Zend_Db_Select object.
     */
    public function calc($flag = true)
    {

        $this->_parts[self::CALC] = (bool) $flag;
     ...
     * @return string
     */
    protected function _renderCalcnumrows($sql)
    {

        if ($this->_parts[self::CALC]) {
            $sql .= ' ' . self::SQL_CALC;
        }
